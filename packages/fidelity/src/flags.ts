 ...
 * timer/renderer backgrounding. See docs/FINDINGS.md (S2). Real `channel=chrome` + an attached display/dummy-HDMI
 ...
 * further tells). See docs/FINDINGS.md (S2); re-verify anytime with `pnpm fidelity:check`.
 */
