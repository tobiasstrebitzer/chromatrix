// Minimal raw-CDP WebSocket client (same helper as spike S1). Kept local so each spike is self-contained;
// promoted into @chromatrix/cdp when the real gateway is built.
